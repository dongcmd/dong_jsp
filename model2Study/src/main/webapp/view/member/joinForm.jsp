...
<form action="join" name="f" method="post" onsubmit="return input_check(this)">
  <input type="hidden" name="picture" value=""> <%-- 업로드된 이미지의 이름 --%>
  <table class="table"><h3>joinForm</h3>
    <tr><td rowspan="4" valign="bottom">
       <img src="" width="100" height="120" id="pic"><br>
       <font size="1"><a href="javascript:win_upload()">사진등록</a></font>
    </td><th>아이디</th>
    <td><input type="text" name="id">
    <button type="button" onclick="idchk()" class="btn btn-primary">중복검사</button>
    </td></tr>
...
<script type="text/javascript">
  ...
  function win_upload() {
  		let op = "width=500, height=500, left=1200, top=300";
  		open("pictureForm","",op);
     }
  ...
  function idchk() {
		if(document.f.id.value == '') {
			...
			let op = "width=500, height=200, left=1200, top=550";
